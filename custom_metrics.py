...
def IoUMetric(y_pred, y_true, softmax=False):
    ...
    # Actually, segmentation masks are only one channel, so don't bother!
...
# [This](https://www.sciencedirect.com/science/article/pii/S0895611121001750#:~:text=The%20most%20commonly%20used%20loss,losses%20for%20handling%20class%20imbalance) is a good paper devising a new loss specifically for image segmentation with medical imaging and lesions.
# The paper gives TensorFlow code, so [this](https://github.com/mlyg/unified-focal-loss/blob/main/loss_functions.py) is an equivalent PyTorch implementation.
